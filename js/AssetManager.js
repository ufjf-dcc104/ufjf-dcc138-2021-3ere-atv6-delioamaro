export default class AssetManager {
    ...
    carregaImagem(chave, source) {
        const img = new Image();
        img.addEventListener("load", () => {console.log(`Imagem ${this.carregadas}/${this.aCarregar} carregada!`)
        this.carregadas ++;
        });
        img.src = source;
    ...
    carregaAudio(chave, source) {
        ...
        audio.addEventListener("loadeddata", () => {console.log(`Audio ${this.carregadas}/${this.aCarregar} carregada!`)
        this.carregadas ++;
        });
        audio.src = source;
