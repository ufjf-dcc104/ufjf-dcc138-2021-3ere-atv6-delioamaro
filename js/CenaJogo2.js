...
export default class CenaJogo2 extends Cena {
    ...
    preparar() {
        ...
        const pc = new Sprite({x:50, y:200, w:20, h:30, tag: "guerreiro", assets:this.assets});
        pc.tags.add("pc");
        const cena = this;
        ...
        const chave = new Sprite({x:50, y:450, tag:"chave", assets:this.assets, tags:["enemy"]});
        this.adicionar(chave);
        const chave2 = new Sprite({x:620, y:50, tag:"chave", assets:this.assets, tags:["enemy"]});
        this.adicionar(chave2);
        const bau = new Sprite({x:220, y:35, tag:"bau", assets:this.assets, tags:["bau"]});
        this.adicionar(bau);
